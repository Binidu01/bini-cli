...
> ⚠️ **Vercel is not yet supported.** We are actively working on a Vercel adapter — follow [the issue](https://github.com/Binidu01/bini-cli/issues) for updates.
...
| Package | Role |
|---|---|
| [`bini-router`](https://npmjs.com/package/bini-router) | File-based routing, nested layouts, metadata, Hono API routes, multi-platform deployment |
...
| [`bini-export`](https://npmjs.com/package/bini-export) | Static SPA export for GitHub Pages, Netlify static, S3 |
